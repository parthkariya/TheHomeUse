        ...
        <section className="sec-privacy-policy">
          <div className="con-privacy-policy">
            ...
            <p className="privacy-policy-subheading-txt">
              The Website Owner being AMEE TRADE, including subsidiaries and
              affiliates (“Website” or “Website Owner” or “we” or “us” or “our”)
              provides the information contained on the website or any of the
              pages comprising the website (“website”) to visitors (“visitors”)
            ...
            <p className="privacy-policy-subheading-txt">
              Welcome to our website www.thehomeuse.com which is owned by AMEE
              TRADE. If you continue to browse and use this website you are
              ...
              AMEE TRADE's relationship with you in relation to this website.
            </p>
            <p className="privacy-policy-subheading-txt">
              The term 'AMEE TRADE' or 'us' or 'we' refers to the owner of the
              website with registered/operational office. The term 'you' refers
            ...
            <ul className="privacy-policy-subheading-list-flex">
              ...
              <li className="privacy-policy-subheading-txt">
                ...
                or document without AMEE TRADE’s prior written consent.
              </li>
              <li className="privacy-policy-subheading-txt">
